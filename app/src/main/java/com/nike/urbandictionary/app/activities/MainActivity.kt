...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?, persistentState: PersistableBundle?) {
        ...
        supportActionBar?.hide() // TODO how to remove bar in manifest agaiin?
        search_bar.setOnQueryTextListener(createSearchQueryListener(viewModel))
        filter_button.setOnClickListener(createFilterClickListener(viewModel))
        item_list.run {
    ...
    private fun createFilterClickListener(vm: DictionaryViewModel) =
        View.OnClickListener { vm.onFilterButtonClick() }
    ...
    fun handleResponseForUI(response: Responses<String>) {
        //TODO finish this.
    }
}